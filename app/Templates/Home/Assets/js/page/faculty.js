		...
		success : function(response) {
			$.each(response, function(key, value) {
				$('#entry').append("<div style='margin-left : 5 px;' class='col-sm-12 col-md-3'>"
								+ "<p><span style='font-weight:bold;text-align:center;color:#001a66;' >Topic: </span><a style='cursor:pointer;' href='"+ DIR +"entry?id="+ value.id +"'><span style='font-weight:bold;text-align:center;color:#000000;' >"+ value.name +"</span></a></p>"
				 				...
				 				+ "<a class='btn btn-sm col-md-12 btn-danger' href=DIR +'entry?id="+value.id+"'> Read More </a>"
				 				+"</div>");
			});
		},
