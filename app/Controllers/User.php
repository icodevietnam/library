...
class User extends Controller { 
    ...
    public function index(){
        ...
        $data['menu'] = 'user';
        $data['roles'] = $this->roles->getFitRoles(Session::get('admin')->roleCode);
    ...
    public function checkStudentCardExist(){
        $studentCard = $_GET['studentCard'];
        echo json_encode($this->users->checkStudentCard($studentCard));
    }
