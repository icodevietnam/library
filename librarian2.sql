...
--
-- Host: localhost
-- Generation Time: Dec 01, 2016 at 03:06 AM
...
CREATE TABLE `author` (
  ...
  `bio` varchar(20000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `category` (`id`, `name`, `description`, `code`, `shortUrl`, `created_date`) VALUES
(2, 'abc', 'aba', 'abc', NULL, '2016-12-01 05:47:09');
...
INSERT INTO `country` (`id`, `name`, `description`, `code`, `created_date`) VALUES
(2, 'vn', 'Viet Nam', 'vn', '2016-12-01 05:14:29');
